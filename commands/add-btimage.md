...
Multiple images can be added by calling the function multiple times.
The images are displayed in the order in which they are added.
...
This example adds a local image to the body of a toast notification with supplied alt text to aid with accessibility e.g.
